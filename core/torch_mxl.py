...
class TorchMXL(nn.Module):
    ...
    def elbo(self, alt_attr, context_attr, obs_choices, alt_avail, obs_mask, alt_ids, indices):
        ...
        q_alpha, q_zeta, q_L_Omega_diag, q_L_Omega_offdiag, q_beta, beta_offsets = self.compute_variational_approximation_q(
            alt_attr, context_attr, obs_choices, alt_avail, alt_ids)
    ...
    def infer(self, num_epochs=10000, true_alpha=None, true_beta=None, true_beta_resp=None):
        ...
        if self.dcm_spec.model_type != 'MNL':
            ...
            if self.use_inference_net:
                q_alpha, q_zeta, q_L_Sigma_diag, q_L_Sigma_offdiag, q_beta, beta_offsets = self.compute_variational_approximation_q(
